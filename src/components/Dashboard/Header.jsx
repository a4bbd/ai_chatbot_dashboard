    ...
    return (
        <div className='header w-full flex'>
               <div className='header-left px-5 py-0 relative w-[260px] h-[60px]'>
                    ...
                    <svg className='text-white w-4 bg-amber-600 h-4  rounded-full ' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevrons-left feather-16"><polyline points="11 17 6 12 11 7"></polyline><polyline points="18 17 13 12 18 7"></polyline></svg>
                    </a>
               </div>
              <div className='flex border  justify-between content-center w-full border-gray-900'>
                   <div className=' items-center ml-5'>
                         <input type='text' placeholder='Search' className='border bg-slate-200  rounded-[50px] relative w-60 h-9 p-2 m-2' />
                            {/* <span>
                   ...
                   <div className='list-none items-center mr-4 flex content-center gap-9'>
                    <div>
                      <a>
                      <svg className='text-slate-800 w-[18px]' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-globe"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
                      <div></div>
                      </a>
                    </div>
                    <div>
