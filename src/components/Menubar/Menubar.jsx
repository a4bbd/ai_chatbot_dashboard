...
const Menubar = ({click}) => {
  ...
  return (
	...
	<div className="sidebar h-full flex">
	  ...
	  <h1 style={click ? {width: "105px" ,opacity:"0.7" , transition : ".2s"}:{width: "271px",opacity:"0.7" }}  className="menu scrollbox mt-[-1px]   bg-white flow  border p-5 border-slate-200 ">
      ...
      <div   className="scrollbox-inner">
						<ul  className="">
							...
							<li className="mt-3">
								...
								<ul className="p-3 ">
									<li>
									{ click ? <NavLink to={"//orders"}> <a className="hover:text-orange-300 transition duration-400 "> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-box"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg></a> </NavLink> : <NavLink to={"/orders"}> <a className="hover:text-orange-300 transition duration-400  flex gap-2 pt-2 pb-2 " ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-box"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg><span>Orders</span></a></NavLink> }
									</li>
									<li>
									{click ? <NavLink to={"/deliverypoint"}> <a className="p-2 transition duration-400  hover:text-orange-300"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-square"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg></a> </NavLink>  : <NavLink to={"/deliverypoint"}>  <a className="hover:text-orange-300 transition duration-400  flex gap-2 pt-2 pb-2 " ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-square"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg><span>Delivery Points</span></a> </NavLink>}
									</li>
