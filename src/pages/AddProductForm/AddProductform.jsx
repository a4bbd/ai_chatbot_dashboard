    ...
    return (
        <div className='mt-5'>
          ...
          <div>
            ...
            <input className='mt-2 focus:border-orange-400 pt-3 pl-3 outline-none rounded pb-3 w-72 border' type='text'/>
            </div>
            <div>
            <label className='block'>Orginal Price</label>
            <input className='mt-2 pt-3 pl-3 focus:border-orange-400 outline-none rounded pb-3 w-72 border' type='text'/>
            </div>
            <div>
          ...
          <div>
                ...
                <input className='mt-2 pt-3 pl-3 focus:border-orange-400 outline-none rounded pb-3 w-72 border' />
            </div>
            <div className='col-start-2 col-end-4'>
                <label className='block'>Product Video</label>
                <input className=' w-full mt-2 pt-3 pl-3 focus:border-orange-400 outline-none rounded pb-3  border' placeholder='Please enter your youtube video link' />
            </div>
             ...
             <div class="flex mt-7 justify-between gap-2 w-full">             
              <div className="">
                <div className="form-group ">
                                    ...
                                    <input className='mt-2 focus:border-orange-400 pt-3 pl-3 outline-none rounded pb-3 w-72 border' type='number'/>
